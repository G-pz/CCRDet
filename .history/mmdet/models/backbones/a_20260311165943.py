...
def compute_displacement_and_warp(x, y, im_file, visualize=True, save_dir="/home/gpz/OD/mmdet-rgbt/flow", step=0):
    """
    计算两个特征图之间的位移场并可视化
    输入: x, y: [B, C, H, W]
...
class AMFusionResNet(TwoStreamResNet):
    ...
    def forward(self, rgb_x, thermal_x):
        ...
        for i in range(self.num_stages):
            ...
            if i < 3:
                rgb_x = compute_displacement_and_warp(rgb_x, thermal_x, im_file=None, visualize=True)
