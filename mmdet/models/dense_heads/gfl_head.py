...
class GFLHead(AnchorHead):
    ...
    def forward(self, feats):
        ...
        """
        cls_score, bbox_pred = multi_apply(self.forward_single, feats, self.scales)
        # save_feature_to_img(cls_score, 'cls_score', self.iter, output_dir='/home/gpz/Pictures/features/afdet/vtuav_wowta')
        # save_feature_to_img(bbox_pred, 'bbox_pred', self.iter, output_dir='/home/gpz/Pictures/features/afdet/vtuav')
